...
// Known 12-hour day and 12-hour night: sunrise 06:00 UTC, sunset 18:00 UTC,
// next sunrise 06:00 UTC. 15 muhurtas per half, each = 12h/15 = 48 minutes.
...
// Classical Muhurta-Chintamani ordinals (0-based), drik-verified over 58 days:
...
describe('computeDurMuhurta', () => {
  ...
  it('night ordinal scales with night length, not day length (9h day / 15h night)', () => {
    ...
    const nightMuhurtaMs = (15 * 3600_000) / 15; // 60 minutes
