/**
 * Unit tests for Chandra Rashi and Surya Nakshatra computation.
 *
 * Chandra Rashi: 12 zodiac signs, 30° each based on Moon longitude.
 * Surya Nakshatra: 27 nakshatras based on Sun longitude.
 */
