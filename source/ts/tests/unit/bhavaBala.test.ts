...
const FIXTURE_PINS: ReadonlyArray<{ name: string; totals: readonly number[] }> = [
  ...
  },
  {
    name: 'Ratan Tata',
    totals: [
      368.3577, 321.1123, 249.6823, 291.2177, 372.7109, 286.0360,
      433.4584, 318.1930, 427.1536, 388.4584, 367.4660, 357.7109,
    ],
  },
  {
    name: 'Dhirubhai Ambani',
    totals: [
      349.8256, 396.7277, 340.2977, 313.3956, 346.4639, 517.2111,
      288.3524, 276.7240, 423.5558, 337.6424, 382.2111, 460.0339,
    ],
  },
  {
    name: 'Mukesh Ambani',
    totals: [
      320.5683, 569.7217, 274.1516, 314.1516, 468.2917, 332.7083,
      369.6061, 417.8971, 330.9049, 527.9775, 377.8971, 481.7461,
    ],
  },
];
