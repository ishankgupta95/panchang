/**
 * An Adhika (intercalary) month is one where the two Amavasyas bounding the
 * reference instant fall in the same solar month, which is what a constant
 * `getSiderealSun` stub forces.
 */
